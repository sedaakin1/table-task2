...
const Navbar = () => {
    return (
        <div style={{
            display: "flex", width: "100%", height: "64px", justifyContent: "space-around",
            background: "white",
            alignItems: "center", boxShadow: "rgb(50 50 93 / 11%) 0px 8px 27px -5px, rgb(0 0 0 / 10%) 0px 8px 16px -8px",
        }}>
            <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                <img src={logoDataURL} alt="logo" style={{ width: '30px', height: '30px', marginLeft: "20px" }} />
                <div style={{ fontSize: "18px" }}>PROTERA CRM</div>
            </div>
            <div>
                <Search>
                    <SearchIconWrapper>
            ...
            <div style={{ minWidth: "177px", width: "177px" }}>
                {" "}
            </div>
        </div>
    )
